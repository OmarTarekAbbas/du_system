...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Send Message ({{$Services[session('OpID')]}})</h1>
    </div>
</div><!--/.row-->
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="canvas-wrapper col-lg-4">
                    {!! Form::open(['url'=>'admin/mt','files'=>true, 'class'=>'mtform']) !!}

                        <div class="form-group row">
                            <label for="mtbody" class="col-sm-12 control-label">Message</label>
                            <textarea id="mtbody" rows="10" cols="50" name="MTBody" class="form-control flat" placeholder="" required></textarea>
                        </div>

                        <div class="form-group row">
                            <label for="date" class="col-sm-12 control-label">Date</label>
                            <div class='input-group date' id='datetimepicker1'>
                                <input type='text' class="form-control col-sm-12" name="date" id="date" required />
                 ...
                 <div class="form-group">
                        ...
                        <div class="form-group row">
<label class="col-sm-6">Media Resource</label>
                        ...
                        <div class="form-group urldiv row">
